...
class AdminDicaController
{
  ...
  public function renderizaFormulario($novo)
  {
    $dados = [
      ...
      'fields' => [
        ['type' => 'readonly', 'name' => 'iddica', 'class' => 'col-3', 'label' => 'Id. Dica'],
        ['type' => 'text', 'name' => 'titulo', 'class' => 'col-5', 'label' => 'Título', 'required'=>true],
        ['type' => 'text', 'name' => 'descricao', 'class' => 'col-6', 'label' => 'Descrição', 'required'=>true],
