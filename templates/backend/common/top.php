                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="/admin/categorias">
                            <div class="sb-nav-link-icon"><i class="bi bi-diagram-2-fill"></i></i></div>
                            Categorias
                        </a>

                        <a class="nav-link" href="/admin/produtos">
                            <div class="sb-nav-link-icon"><i class="bi bi-tags-fill"></i></i></div>
                            Produtos
                        </a>

                        <a class="nav-link" href="/admin/empresas">
                            <div class="sb-nav-link-icon"><i class="bi bi-geo-alt-fill"></i></i></div>
                            Empresas
                        </a>
